...
public class RetryerBuilder<V> {
     ...
     *
     * @param resultPredicate a predicate applied to the result, and which causes the retryer to
     *     retry if the predicate is satisfied
     * @return <code>this</code>
     */
    public RetryerBuilder<V> retryIfResult(@Nullable Predicate<V> resultPredicate) {
        ...
        rejectionPredicate =
                Predicates.or(rejectionPredicate, new ResultPredicate<>(resultPredicate));
        return this;
    }
    ...
    public Retryer<V> build() {
        AttemptTimeLimiter<V> theAttemptTimeLimiter =
                attemptTimeLimiter == null
                        ? AttemptTimeLimiters.<V>noTimeLimit()
                        : attemptTimeLimiter;
        StopStrategy theStopStrategy =
