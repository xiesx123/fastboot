/*
 * Copyright 2020-2020 Ray Holder
 *
...
public class RetryerBuilder<V> {
   ...
   */
  public RetryerBuilder<V> withRetryListener(@Nullable RetryListener listener) {
   ...
   */
  public RetryerBuilder<V> withWaitStrategy(@Nullable WaitStrategy waitStrategy)
      throws IllegalStateException {
    Preconditions.checkNotNull(waitStrategy, "waitStrategy may not be null");
    Preconditions.checkState(
        this.waitStrategy == null, "a wait strategy has already been set %s", this.waitStrategy);
   ...
   */
  public RetryerBuilder<V> withStopStrategy(@Nullable StopStrategy stopStrategy)
      throws IllegalStateException {
    Preconditions.checkNotNull(stopStrategy, "stopStrategy may not be null");
    Preconditions.checkState(
        this.stopStrategy == null, "a stop strategy has already been set %s", this.stopStrategy);
   ...
   */
  public RetryerBuilder<V> withBlockStrategy(@Nullable BlockStrategy blockStrategy)
      throws IllegalStateException {
    Preconditions.checkNotNull(blockStrategy, "blockStrategy may not be null");
    Preconditions.checkState(
        this.blockStrategy == null, "a block strategy has already been set %s", this.blockStrategy);
  ...
  public RetryerBuilder<V> withAttemptTimeLimiter(
      @Nullable AttemptTimeLimiter<V> attemptTimeLimiter) {
  ...
  public RetryerBuilder<V> retryIfException() {
    rejectionPredicate =
        Predicates.or(rejectionPredicate, new ExceptionClassPredicate<V>(Exception.class));
    return this;
  }

  /**
   * Configures the retryer to retry if a runtime exception (i.e. any <code>RuntimeException
   * </code> or subclass of <code>RuntimeException</code>) is thrown by the call.
   *
   * @return <code>this</code>
   */
  public RetryerBuilder<V> retryIfRuntimeException() {
    rejectionPredicate =
        Predicates.or(rejectionPredicate, new ExceptionClassPredicate<V>(RuntimeException.class));
    return this;
  }
  ...
  public RetryerBuilder<V> retryIfExceptionOfType(
    ...
    rejectionPredicate =
        Predicates.or(rejectionPredicate, new ExceptionClassPredicate<V>(exceptionClass));
    return this;
  }
   ...
   * @return <code>this</code>
   */
  public RetryerBuilder<V> retryIfException(@Nullable Predicate<Throwable> exceptionPredicate) {
    Preconditions.checkNotNull(exceptionPredicate, "exceptionPredicate may not be null");
    rejectionPredicate =
        Predicates.or(rejectionPredicate, new ExceptionPredicate<V>(exceptionPredicate));
    return this;
  }
   ...
   * @return <code>this</code>
   */
  public RetryerBuilder<V> retryIfResult(@Nullable Predicate<V> resultPredicate) {
  ...
  private static final class ExceptionClassPredicate<V> implements Predicate<Attempt<V>> {
    ...
    @Override
    public boolean apply(@Nullable Attempt<V> attempt) {
