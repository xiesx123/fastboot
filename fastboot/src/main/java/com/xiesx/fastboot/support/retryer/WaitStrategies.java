...
public final class WaitStrategies {
   ...
   */
  public static WaitStrategy fixedWait(long sleepTime, @Nullable TimeUnit timeUnit)
   ...
   */
  public static WaitStrategy randomWait(long maximumTime, @Nullable TimeUnit timeUnit) {
    Preconditions.checkNotNull(timeUnit, "The time unit may not be null");
  ...
  public static WaitStrategy randomWait(
      long minimumTime,
      @Nullable TimeUnit minimumTimeUnit,
      long maximumTime,
      @Nullable TimeUnit maximumTimeUnit) {
  ...
  public static WaitStrategy incrementingWait(
      ...
      @Nullable TimeUnit initialSleepTimeUnit,
      long increment,
      @Nullable TimeUnit incrementTimeUnit) {
   ...
   * @return a wait strategy that increments with each failed attempt using exponential backoff
   */
  public static WaitStrategy exponentialWait(long maximumTime, @Nullable TimeUnit maximumTimeUnit) {
    Preconditions.checkNotNull(maximumTimeUnit, "The maximum time unit may not be null");
   ...
   */
  public static WaitStrategy exponentialWait(
      long multiplier, long maximumTime, @Nullable TimeUnit maximumTimeUnit) {
    Preconditions.checkNotNull(maximumTimeUnit, "The maximum time unit may not be null");
   ...
   * @return a wait strategy that increments with each failed attempt using a Fibonacci sequence
   */
  public static WaitStrategy fibonacciWait(long maximumTime, @Nullable TimeUnit maximumTimeUnit) {
    Preconditions.checkNotNull(maximumTimeUnit, "The maximum time unit may not be null");
   ...
   * {@code function} determines how the sleep time should be calculated for the given {@code
  ...
  public static <T extends Throwable> WaitStrategy exceptionWait(
      @Nullable Class<T> exceptionClass, @Nullable Function<T, Long> function) {
  ...
  private static final class IncrementingWaitStrategy implements WaitStrategy {
    ...
    public IncrementingWaitStrategy(long initialSleepTime, long increment) {
      Preconditions.checkArgument(
          initialSleepTime >= 0L, "initialSleepTime must be >= 0 but is %d", initialSleepTime);
  ...
  private static final class ExponentialWaitStrategy implements WaitStrategy {
    ...
    public ExponentialWaitStrategy(long multiplier, long maximumWait) {
      ...
      Preconditions.checkArgument(
          multiplier < maximumWait, "multiplier must be < maximumWait but is %d", multiplier);
