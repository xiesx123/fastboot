...
/**
 * @title AviatorManager.java
 * @description https://www.cnblogs.com/csguo/p/7614893.html
 * @author xiesx
 * @date 2022-11-12 19:35:58
 */
@Log4j2
@UtilityClass
public class AviatorManager {
    ...
    public static void main(String[] args) {
        ...
        Console.log(isInvoke("invoke($.x1.x2,-4)", Dict.create().set("x1", Dict.create().set("x2", Lists.newArrayList(-1, -2, -3)))));// true
        Console.log(isInvoke("invoke($.x1.x2,0)", Dict.create().set("x1", Dict.create().set("x2", Lists.newArrayList(1, 2, 3)))));// false
    }
}
